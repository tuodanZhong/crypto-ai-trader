...
| `btc_eth_leverage` | Максимальне плече для BTC/ETH | `5` (за замовчуванням, безпечно)<br>`20` (максимум системи) | ✅ Так |
| `altcoin_leverage` | Максимальне плече для альткоїнів | `5` (за замовчуванням, безпечно)<br>`15` (максимум системи) | ✅ Так |
