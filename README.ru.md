...
| `btc_eth_leverage` | Максимальное плечо для BTC/ETH | `5` (по умолчанию, безопасно)<br>`20` (максимум системы) | ✅ Да |
| `altcoin_leverage` | Максимальное плечо для альткоинов | `5` (по умолчанию, безопасно)<br>`15` (максимум системы) | ✅ Да |
